...
DefinitionBlock("", "SSDT", 2, "hack", "PTSWAK", 0)
{
    ...
    External(RP01.PXSX._ON, MethodObj)
    External(RP01.PXSX._OFF, MethodObj)
    ...
    {   
        ...
        If (3 == Arg0)
        {
            If (CondRefOf (\EISC))
            {
                \EISC (0x81, 0x16, 2) //Dell PowerLED
            }
            If (CondRefOf(\_SI._SST)) { \_SI._SST (1) } //ThinkPad PowerLED
        }
